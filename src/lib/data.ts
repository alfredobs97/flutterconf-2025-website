...
export const day1Schedule: AgendaEvent[] = [
    ...
    { time: '11:45', title: 'Recetas Mágicas para Android Studio con Gemini', type: 'talk', duration: 30, speaker: 'Gema Socorro Rodríguez' },
    { time: '12:15', title: 'An introduction to Building Games with Flutter & Flame', type: 'talk', duration: 30, speaker: 'Lukas Klingsbo' },
    { time: '12:45', title: 'Gestiona el modo mantenimiento y las versiones de tu app con Firebase.', type: 'talk', duration: 30, speaker: 'Victor Carreras' },
