    ...
    <section id="speakers">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-4 mb-12">
          <h2 className="text-3xl font-headline font-bold tracking-tight sm:text-4xl">{t('speakers2025.title')}</h2>
          <p className="max-w-2xl text-muted-foreground text-lg">
            {t('speakers2025.subtitle')}
          </p>
        </div>
          ...
          {speakers.length <= 1 && (
            <Card className="flex items-center justify-center border-2 border-dashed bg-secondary/50">
              <CardContent className="text-center text-muted-foreground p-6">
                ...
                <h3 className="font-bold font-headline text-lg text-foreground">{t('speakers2025.moreSpeakers')}</h3>
                <p>{t('speakers2025.workingOnIt')}</p>
              </CardContent>
            </Card>
          )}
        </div>
