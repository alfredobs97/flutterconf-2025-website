                        ...
                        <CardContent className="p-8 md:p-12">
                            <div className="text-center mb-10">
                                ...
                                <h2 className="text-3xl sm:text-4xl font-headline font-bold mb-4">
                                    <Link href="#sponsors" className="hover:text-primary transition-colors">¿Quieres apoyar la FlutterConf?</Link>
                                </h2>
                                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                    Únete a las empresas que apoyan el crecimiento de la comunidad Flutter en España.
                                    Gana visibilidad y conecta con desarrolladores talentosos.
                                </p>
                            </div>

                            <div className="mb-10">
                                <h3 className="text-xl font-semibold text-center mb-6">Sponsors 2025</h3>
                                ...
                                <h3 className="text-xl font-semibold text-center mb-6">Colaboradores 2025</h3>
